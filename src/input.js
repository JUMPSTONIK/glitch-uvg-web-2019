    ...
    return (
      <div style={divStyle}>
        <form style={formStyle}>
          ...
          {this.state.input !== '' ? (
            <div style={divS}>
              <button type="button" aria-label="Save" value="X" className="fa fa-times" style={input2Style} onClick={this.clearText} tabIndex="-2" />
              <button type="button" aria-label="Save" className="fa fa-search" style={inputSearch} onClick={this.search} tabIndex="-1" />
            </div>
          )
            : <button type="button" aria-label="Save" className="fa fa-search hover" tabIndex="-1" /> }
        </form>
      </div>
    );
  }
